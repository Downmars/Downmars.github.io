...
`PaperMod`主题使用的代码高亮工具为[Chroma](https://github.com/alecthomas/chroma)，可能不太聪明，但是对于我的日常使用暂时没有太大问题。
...
我已经忍这个默认字体很久了，现在我们就在这里干掉他。我们在这里选择[霞鹜文楷](https://github.com/lxgw/LxgwWenKai?tab=readme-ov-file)，配置方法参考[Hugo使用自定义字体](https://zhuanlan.zhihu.com/p/627444050)。

> 本应该英文和中文分开配置字体，但是我暂时没有找到较好的方法，并且暂时显示效果还可以，就暂时搁置了。

我们在`layouts/partials/extend_head.html`中加入：
```html 
