...
{{< figure src="/blog_images/CC-BY-NC-4.png" alt="CC-BY-NC-4" title="CC-BY-NC-4"  align="center" >}}
...
.sidenote-number:hover .sidenote {
  ...
  box-shadow: 0 4px 8px var(--sidenote-shadow2); /* 悬停时加强阴影效果 */
}

```
{{< /collapse >}}

同时，对于`shortcode`也有相应的修改，在`layouts/shortcodes/sidenote.html`中添加以下内容：
